...
export default {
  ...
  setup() {
    ...
    const getImageUrl = (imagePath) => {
      ...
      return imagePath.startsWith('http') ? imagePath : `http://myshop0101.azurewebsites.net/${imagePath}`;
    };
    ...
    const loadProducts = async () => {
      ...
      try {
        const response = await axios.get('http://myshop0101.azurewebsites.net/api/Product/getAll');
